...
public class yahtzeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelDisplayScore = new javax.swing.JLabel();
        ...
        jButton9.setText("4 OF A KIND");
        jButton9.setEnabled(false);
        getContentPane().add(jButton9);
        jButton9.setBounds(590, 223, 110, 30);

        jButton10.setText("FULL HOUSE");
        jButton10.setEnabled(false);
        getContentPane().add(jButton10);
        jButton10.setBounds(590, 250, 110, 23);

        jButton11.setText("SM. STRAIGHT");
        jButton11.setEnabled(false);
        getContentPane().add(jButton11);
        jButton11.setBounds(590, 270, 110, 30);

        jButton12.setText("LG. STRAIGHT");
        jButton12.setEnabled(false);
        getContentPane().add(jButton12);
        jButton12.setBounds(590, 293, 110, 30);
        ...
        labelChoose.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        labelChoose.setForeground(new java.awt.Color(204, 255, 102));
        labelChoose.setText("Click the dice you want to keep. Then roll again when ready");
        getContentPane().add(labelChoose);
        labelChoose.setBounds(10, 370, 530, 20);
        getContentPane().add(jLabel3);
        jLabel3.setBounds(580, 0, 200, 200);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(580, 200, 210, 170);

        labelDisplayScore.setText("Score:");
        getContentPane().add(labelDisplayScore);
        labelDisplayScore.setBounds(320, 290, 34, 14);

        labelScore.setText("SCORE");
        getContentPane().add(labelScore);
        labelScore.setBounds(410, 290, 34, 14);
    ...
    private javax.swing.JLabel labelDisplayScore;
